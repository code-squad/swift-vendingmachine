...
final class VendingMachine: Singleton, Sequence {
    ...
    enum Menu: String, CustomStringConvertible, EnumCollection {
        ...
        var description: String {
            ...
            return String.init(describing: type(of: generate()))
        }
        ...
        fileprivate func generate() -> Beverage {
            ...
            switch self {
            case .strawberryMilk: beverage = StrawBerryMilk("서울우유", 200, 1000, rawValue, Date(timeIntervalSinceNow: 0), Date(timeIntervalSinceNow: 60*60*24*7), 210, manufacturerCode: 1001, packingMaterial: "종이")
            case .bananaMilk: beverage = BananaMilk("서울우유", 200, 1000, rawValue, Date(timeIntervalSinceNow: 0), Date(timeIntervalSinceNow: 60*60*24*7), 220, manufacturerCode: 1001, packingMaterial: "종이")
            case .chocoMilk: beverage = ChocoMilk("서울우유", 200, 1000, rawValue, Date(timeIntervalSinceNow: 0), Date(timeIntervalSinceNow: 60*60*24*7), 240, manufacturerCode: 1001, packingMaterial: "종이")
            case .coke: beverage = CokeSoftDrink("펩시", 350, 2000, rawValue, Date(timeIntervalSinceNow: 0), Date(timeIntervalSinceNow: 60*60*24*30*6), 250, carbonContent: 50)
            case .cider: beverage = CiderSoftDrink("롯데칠성음료", 350, 2000, rawValue, Date(timeIntervalSinceNow: 0), Date(timeIntervalSinceNow: 60*60*24*30*6), 250, carbonContent: 60)
            case .fanta: beverage = FantaSoftDrink("코카콜라컴퍼니", 350, 2000, rawValue, Date(timeIntervalSinceNow: 0), Date(timeIntervalSinceNow: 60*60*24*30*7), 300, carbonContent: 40)
            case .top: beverage = TopCoffee("맥심", 200, 2200, rawValue, Date(timeIntervalSinceNow: 0), Date(timeIntervalSinceNow: 60*60*24*14), 240, caffeineLevels: 20, isHot: true, isSweetened: true)
            case .cantata: beverage = CantataCoffee("롯데칠성음료", 200, 2200, rawValue, Date(timeIntervalSinceNow: 0), Date(timeIntervalSinceNow: 60*60*24*14), 250, caffeineLevels: 10, isHot: false, isSweetened: true)
            case .georgia: beverage = GeorgiaCoffee("코카콜라", 200, 2200, rawValue, Date(timeIntervalSinceNow: 0), Date(timeIntervalSinceNow: 60*60*24*2), 100, caffeineLevels: 25, isHot: true, isSweetened: false)
            }
            return beverage
        }
