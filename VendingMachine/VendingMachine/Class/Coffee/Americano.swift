...
class Americano: Coffee {
    ...
    init(brand: String = "동서식품", capacity: Int = 275, price: Int = 2200, name: String = "티오피 더블랙", date: Date = Date("20191001"), coffeeType: CoffeeType = .americano, espressoRatio: Double = 12.6) {
