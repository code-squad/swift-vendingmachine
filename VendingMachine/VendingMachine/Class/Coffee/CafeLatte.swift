...
class CafeLatte: Coffee {
    ...
    init(brand: String = "동서식품", capacity: Int = 275, price: Int = 2200, name: String = "티오피 마스터 라떼", expirationDate: Date = Date("20191002"), coffeeType: CoffeeType = .cafeLatte, temperature: Int = 20, milkRatio: Double = 15) {
