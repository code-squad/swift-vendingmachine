...
class LemonlimeDrink: Soda {
    ...
    init(brand: String = "코카콜라", capacity: Int = 215, price: Int = 1300, name: String = "스프라이트", expirationDate: Date = Date(), temperature: Int = 7, sugarContent: Double = 24, lemonScentContent: Double = 1) {
