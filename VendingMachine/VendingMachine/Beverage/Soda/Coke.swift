...
class Coke: Soda {
    ...
    init(brand: String = "코카콜라", capacity: Int = 210, price: Int = 1100, name: String = "코카콜라", expirationDate: Date = Date(), temperature: Int = 10, sugarContent: Double = 23, caffeineContent: Double = 16) {
