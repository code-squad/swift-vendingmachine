...
enum BeverageMenu {
    ...
    func makeInstance() -> Beverage {
        ...
        case .georgia:
            return Georgia(brand: "코카콜라", volume: 240, price: 1100, productName: "조지아 오리지널", expiryDate: today, calorie: 94, isHot: false)
        case .pepsi:
        ...
        case .top:
            return TOP(brand: "맥심", volume: 275, price: 1800, productName: "TOP 스위트아메리카노", expiryDate: today, calorie: 48, isHot: true)
        }
    }
}
