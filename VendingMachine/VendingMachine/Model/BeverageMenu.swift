...
enum BeverageMenu {
    ...
    func makeInstance() -> Beverage {
        ...
        switch self {
        case .bananaMilk:
            return BananaMilk(brand: "빙그레", volume: 250, price: 1500, productName: "바나나우유", expiryDate: today, calorie: 300, quantity: 0)
        case .cocaCola:
        ...
        case .top:
            return TOP(brand: "맥심", volume: 275, price: 1800, productName: "TOP 스위트아메리카노", expiryDate: today, calorie: 48, quantity: 0)
        }
    }
}
