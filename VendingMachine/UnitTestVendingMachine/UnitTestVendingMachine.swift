...
class UnitTestVendingMachine: XCTestCase {
    ...
    func test_자판기_우유_유통기한_메소드_확인() {
        ...
        formatter.dateFormat = "yyyyMMdd"
        let justMilk = Milk(brand: "서울우유", weight: 100, price: 1200, name: "서울하얀우유",
                            formatter.date(from: "20171015") ?? Date())
    ...
    func test_자판기_소다_당류_값확인() {
        ...
        let sprite = Sprite(brand: "코카콜라", weight: 100, price: 1200, name: "스프라이트",
                            manufactureDate: formatter.date(from: "20180101") ?? Date())
    ...
    func test_자판기_사이다_향첨가_종류확인() {
        ...
        let cilsungCidar = Sprite(brand: "칠성", weight: 300, price: 2500, name: "달지않은사이다",
                   manufactureDate: formatter.date(from: "20180103") ?? Date(), flavoringSyrups: "레몬라임향")
    ...
    func test_자판기_환타_캔재질_확인() {
        ...
        let somiFanta = Fanta(brand: "코카콜라", weight: 300, price: 2500, name: "소미환타",
                              manufactureDate: formatter.date(from: "20180104") ?? Date(), materials: "Aluminum")
    ...
    func test_자판기_조지아_커피추출액량_확인() {
        ...
        let maxCoffee = Georgia(brand: "조지아", weight: 300, price: 2500, name: "맥스커피",
                                manufactureDate: formatter.date(from: "20180104") ?? Date(), coffeeExtrack: 12.6)
    ...
    func test_자판기_Kantata_원두종류_확인() {
        ...
        let dutchBlack = Kantata(brand: "롯데칠성", weight: 350, price: 2100, name: "더치블랙",
                                 manufactureDate: formatter.date(from: "20180109") ?? Date(),
                                 kindOfBeans: "GuatemalaAntiqua")
