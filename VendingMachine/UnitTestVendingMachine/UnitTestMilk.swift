...
class UnitTestMilk: XCTestCase {
    ...
    override func setUp() {
        ...
        staleMilk = Milk(brand: "서울우유", weight: "200ml", price: "3000원", name: "날마다 우유", dateOfManufacture: "20170902", calorie: "200kcal")
        freshMilk = Milk(brand: "서울우유", weight: "300ml", price: "5000원", name: "날마다우유", dateOfManufacture: "20171110", calorie: "150kcal", ingredients: ["lactose"])
    }
