...
class CantataCoffee: Coffee{
    ...
    init(brand: String, quantity: Int, price: Int, name: String, date: Date, coffeine: Double = 100.0, bean: CoffeeBean = CoffeeBean.arabica, model: String = "1Bean", calorySet: CaloryElements, temperature: Double) {
        self.model = model
