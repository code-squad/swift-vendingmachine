...
class VendingMachineTest: XCTestCase {
    ...
    func testVeningMachine_properties() {
        ...
        XCTAssertEqual(vendingMachine.description, "coins: 1000원, inventory: [\"딸기우유\": [딸기우유(StrawberryMilk) - 서울우유, 200ml, 1000원, 딸기우유, 20171211], \"펩시콜라\": [펩시콜라(PepciCoke) - 펩시, 350ml, 2000원, 다이어트콜라, 20171211]]")
    }
