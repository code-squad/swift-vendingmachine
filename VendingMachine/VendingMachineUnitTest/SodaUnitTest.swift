...
class SodaUnitTest: XCTestCase {
    ...
    func testSodaInstantiate_success() {
        XCTAssertNotNil(Soda(brand: "동아오츠카", capacity: 350, price: 2000, name: "포카리", manufacturedDate: "20180101", calories: 20, isHot: false))
    }
    
    func test99Calories_SodaIsLowCalories() {
        let testCalories = 99
        let soda = Soda(brand: "동아오츠카", capacity: 350, price: 2000, name: "포카리", manufacturedDate: "20180101", calories: testCalories, isHot: false)
